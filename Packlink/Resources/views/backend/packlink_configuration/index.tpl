...
{block name="scripts"}
    ...
    <script type="text/javascript" src="{link file="backend/_resources/js/DefaultParcelController.js"}"></script>
    <script type="text/javascript" src="{link file="backend/_resources/js/DefaultWarehouseController.js"}"></script>
    <script type="text/javascript" src="{link file="backend/_resources/js/FooterController.js"}"></script>
    <script type="text/javascript" src="{link file="backend/_resources/js/OrderStateMappingController.js"}"></script>
    <script type="text/javascript" src="{link file="backend/_resources/js/PageControllerFactory.js"}"></script>
    <script type="text/javascript" src="{link file="backend/_resources/js/ShippingMethodsController.js"}"></script>
            ...
            <div class="pl-sidebar-wrapper">
                ...
                <div id="pl-sidebar-shipping-methods-btn" class="pl-sidebar-link-wrapper pl-sidebar-link"
                    ...
                    <div class="pl-sidebar-link-wrapper-inner">
                        ...
                        <div class="pl-sidebar-text-wrapper">
                            {s name="configuration/services"}SHIPPING SERVICES{/s}
                        </div>
                    </div>
                </div>
                <div id="pl-sidebar-basic-settings-btn" class="pl-sidebar-link-wrapper"
                    ...
                    <div class="pl-sidebar-link-wrapper-inner">
                        ...
                        <div class="pl-sidebar-text-wrapper">
                            {s name="configuration/basicsettings"}BASIC SETTINGS{/s}
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-help">
                    <a class="pl-link" href="{$helpUrl}" target="_blank">
                        <span>
                            {s name="configuration/help"}Help{/s}
                        </span>
                    ...
                    <div class="pl-contact">
                        {s name="configuration/contactus"}Contact us{/s}:
                    </div>
    ...
    <div class="pl-template-section">
        <div id="pl-sidebar-subitem-template">
            <div class="row pl-sidebar-subitem-wrapper" data-pl-sidebar-btn="order-state-mapping">
                <div>
                    {s name="configuration/maporderstatuses"}Map order statuses{/s}
                </div>
            </div>
            <div class="row pl-sidebar-subitem-wrapper" data-pl-sidebar-btn="default-warehouse">
                <div>
                    {s name="configuration/defaultwarehouse"}Default warehouse{/s}
                </div>
            </div>
            <div class="row pl-sidebar-subitem-wrapper" data-pl-sidebar-btn="default-parcel">
                <div>
                    {s name="configuration/defaultparcel"}Default parcel{/s}
                </div>
            </div>
        </div>
                ...
                <div class="pl-basic-settings-page-wrapper">
                    <div class="row">
                        <div class="pl-basic-settings-page-title-wrapper">
                            {s name="configuration/setdefaultparcel"}Set default parcel{/s}
                        </div>
                    </div>
                    <div class="row">
                        <div class="pl-basic-settings-page-description-wrapper">
                            {s name="configuration/defaultparceldesc"}We will use the default parcel in case any item has not defined dimensions and weight. You can edit anytime.{/s}
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input pl-parcel-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/weight"}Weight{/s} (kg)
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="pl-basic-settings-page-form-input-item pl-inline-input">
                                    <div class=" pl-form-section-input pl-text-input pl-parcel-input">
                                        ...
                                        <span class="pl-text-input-label">{s name="configuration/lenght"}Length{/s} (cm)</span>
                                    </div>
                                    <div class=" pl-form-section-input pl-text-input pl-parcel-input">
                                        <input type="text" id="pl-default-parcel-width"/>
                                        <span class="pl-text-input-label">{s name="configuration/width"}Width{/s} (cm)</span>
                                    </div>
                                    <div class=" pl-form-section-input pl-text-input pl-parcel-input">
                                        <input type="text" id="pl-default-parcel-height"/>
                                        <span class="pl-text-input-label">{s name="configuration/height"}Height{/s} (cm)</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="pl-basic-settings-page-form-input-item pl-parcel-button">
                                    <button type="button" class="button button-primary btn-lg"
                                            id="pl-default-parcel-submit-btn">{s name="configuration/savechanges"}Save changes{/s}</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="pl-default-warehouse-template">
            <div class="row">
                <div class="pl-basic-settings-page-wrapper">
                    <div class="row">
                        <div class="pl-basic-settings-page-title-wrapper">
                            {s name="configuration/setdefaultwarehouse"}Set default warehouse{/s}
                        </div>
                    </div>
                    <div class="row">
                        <div class="pl-basic-settings-page-description-wrapper">
                            {s name="configuration/defaultwarehousedesc"}We will use the default Warehouse address as your sender address. You can edit anytime.{/s}
                        </div>
                    </div>
                    <div class="row">
                        <div class="pl-basic-settings-page-form-wrapper">
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/warehousename"}Warehouse name{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/contactpersonname"}Contact person name{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/contactpersonsurname"}Contact person surname{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/companyname"}Company name{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/cityorpostalcode"}City or postal code{/s}
                                        </span>
                            ...
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/address"}Address{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class=" pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/phonenumber"}Phone number{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <div class="pl-form-section-input pl-text-input">
                                        ...
                                        <span class="pl-text-input-label">
                                            {s name="configuration/email"}Email{/s}
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class=" pl-basic-settings-page-form-input-item">
                                    <button type="button" class="button button-primary btn-lg"
                                        ...
                                        {s name="configuration/savechanges"}Save changes{/s}
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div id="pl-shipping-methods-page-template">
            ...
            <div class="pl-dashboard-modal-wrapper hidden" id="pl-disable-methods-modal-wrapper">
                <div class="pl-dashboard-modal pl-disable-methods-modal" id="pl-disable-methods-modal">
                    <div class="pl-shipping-modal-title">
                        {s name="configuration/firstmethodcreated"}Congrats! Your first Shipping Method has been successfully created.{/s}
                    </div>
            ...
            <div class="pl-dashboard-modal-wrapper hidden" id="pl-dashboard-modal-wrapper">
                <div class="pl-dashboard-modal" id="pl-dashboard-modal">
                    <img src="{link file="backend/_resources/images/dashboard.png"}">
                    <div class="pl-dashboard-page-title-wrapper">
                        {s name="configuration/almostthere"}You're almost there!{/s}
                    </div>
                    <div class="pl-dashboard-page-subtitle-wrapper">
                        {s name="configuration/detailssynceddesc"}Details synced with your existing account{/s}
                    </div>
                    <div class="pl-dashboard-page-step-wrapper pl-dashboard-page-step" id="pl-parcel-step">
                        ...
                        <div class="pl-step-title">
                            {s name="configuration/parcelstep"}Set default parcel details{/s}
                        </div>
                    </div>
                    <div class="pl-dashboard-page-step-wrapper pl-dashboard-page-step" id="pl-warehouse-step">
                        ...
                        <div class="pl-step-title">
                            {s name="configuration/warehousestep"}Set default warehouse details{/s}
                        </div>
                    </div>
                    <div class="pl-dashboard-page-subtitle-wrapper" id="pl-step-subtitle">
                        {s name="configuration/fewmoresteps"}Just a few more steps to complete the setup{/s}
                    </div>
                    <div class="pl-dashboard-page-step-wrapper pl-dashboard-page-step" id="pl-shipping-methods-step">
                        ...
                        <div class="pl-step-title">
                            {s name="configuration/shippingservicesstep"}Select shipping services{/s}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="pl-shipping-methods-filters-template">
            <div class="row">
                <div class="pl-filter-method-tile">
                    {s name="configuration/filterservices"}Filter services{/s}
                </div>
            </div>
            <div class="row">
                <div class="pl-filter-method">
                    <b>
                        {s name="configuration/type"}Type{/s}
                    </b>
                </div>
            </div>
            <div class="row">
                <div class="pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/national"}National{/s}
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/international"}International{/s}
                        </label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="pl-filter-method">
                    <b>
                        {s name="configuration/deliverytype"}Delivery type{/s}
                    </b>
                </div>
            </div>
            <div class="row">
                <div class="pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/economic"}Economic{/s}
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class="pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/express"}Express{/s}
                        </label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="pl-filter-method">
                    <b>
                        {s name="configuration/parcelorigin"}Parcel origin{/s}
                    </b>
                </div>
            </div>
            <div class="row">
                <div class="pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/collection"}Collection{/s}
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class=" pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/dropoff"}Drop off{/s}
                        </label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class=" pl-filter-method">
                    <b>
                        {s name="configuration/parceldestination"}Parcel destination{/s}
                    </b>
                </div>
            </div>
            <div class="row">
                <div class=" pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/delivery"}Delivery{/s}
                        </label>
                    </div>
                </div>
            </div>
                ...
                <div class=" pl-filter-method-item">
                    <div class="md-checkbox">
                        <label>
                            ...
                            {s name="configuration/pickup"}Pick up{/s}
                        </label>
                    </div>
                </div>
            </div>
                ...
                <td colspan="9">
                            ...
                            <div class="row pl-shipping-method-form">
                                <div class=" pl-form-section-wrapper">
                                    <div class="row">
                                        <div class=" pl-form-section-title-wrapper">
                                            <div class="pl-form-section-title">
                                                {s name="configuration/addservicetitle"}Add service title{/s}
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class=" pl-form-section-subtitle-wrapper">
                                            {s name="configuration/servicetitledesc"}This title will be visible to your customers{/s}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class=" pl-form-section-input-wrapper">
                                            <div class="form-group pl-form-section-input pl-text-input">
                                                ...
                                                <span class="pl-text-input-label">
                                                    {s name="configuration/servicetitlelabel"}Service title{/s}
                                                </span>
                                            </div>
                                            <div class="row">
                                                <div class=" pl-form-section-title-wrapper">
                                                    <div class="pl-form-section-title">
                                                        {s name="configuration/carrierlogotitle"}Carrier logo{/s}
                                                    </div>
                                                    <div class="pl-form-section-title-line">
                                                        <hr>
                                                    </div>
                                            ...
                                            <div class="md-checkbox">
                                                <label class="pl-form-section-input-checkbox-label">
                                                    <input type="checkbox" name="method-show-logo-input" checked
                                                           id="pl-show-logo">
                                                    {s name="configuration/carrierlogolabel"}Show carrier logo to my customers{/s}
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class=" pl-form-section-wrapper">
                                    <div class="row">
                                        <div class=" pl-form-section-title-wrapper">
                                            <div class="pl-form-section-title">
                                                {s name="configuration/pricingpolicytitle"}Select pricing policy{/s}
                                            </div>
                                            <div class="pl-form-section-title-line">
                                                <hr>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class=" pl-form-section-subtitle-wrapper">
                                            {s name="configuration/pricingpolicydesc"}Choose the pricing policy to show your customers{/s}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class=" pl-form-section-input-wrapper">
                                            <div class="form-group pl-form-section-input">
                                                <select id="pl-pricing-policy-selector">
                                                    <option value="1">
                                                        {s name="configuration/packlinkprices"}Packlink prices{/s}
                                                    </option>
                                                    <option value="2">
                                                        {s name="configuration/precent"}% of Packlink prices{/s}
                                                    </option>
                                                    <option value="3">
                                                        {s name="configuration/fixedweight"}Fixed prices based on total weight{/s}
                                                    </option>
                                                    <option value="4">
                                                        {s name="configuration/fixedprice"}Fixed prices based on total price{/s}
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row pl-tax-spacer">
                                        <div class="pl-form-section-subtitle-wrapper">
                                            {s name="configuration/tax"}Tax{/s}
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="pl-form-section-input-wrapper">
                    ...
                    <div class="row">
                        <div class="pl-configure-shipping-method-button-wrapper">
                            <button type="button" class="button button-primary btn-lg" id="pl-shipping-method-config-save-btn">
                                {s name="configuration/save"}Save{/s}
                            </button>
                            <button type="button" class="button btn-outline-secondary btn-lg" id="pl-shipping-method-config-cancel-btn">
                                {s name="configuration/cancel"}Cancel{/s}
                            </button>
                        </div>
                    </div>
            ...
            <tr class="pl-table-row-wrapper">
                ...
                <td class="pl-table-row-method-title">
                    ...
                    <p class="pl-price-indicator" data-pl-price-indicator="packlink">
                        {s name="configuration/packlinkpricesindicator"}Packlink prices{/s}
                    </p>
                    <p class="pl-price-indicator" data-pl-price-indicator="percent">
                        {s name="configuration/packlinkpercentindicator"}Packlink percent{/s}
                    </p>
                    <p class="pl-price-indicator" data-pl-price-indicator="fixed-weight">
                        {s name="configuration/fixedweightdesc"}Fixed prices based on total weight{/s}
                    </p>
                    <p class="pl-price-indicator" data-pl-price-indicator="fixed-value">
                        {s name="configuration/fixedpricedesc"}Fixed prices based on total price{/s}
                    </p>
                </td>
            ...
            <div class="row">
                <div class=" pl-nav-wrapper">
                    <div class="pl-nav-item selected" data-pl-shipping-methods-nav-button="all" tabindex="-1">
                        {s name="configuration/allshippingservices"}All shipping services{/s}
                    </div>
                    <div class="pl-nav-item" data-pl-shipping-methods-nav-button="selected" tabindex="-1">
                        {s name="configuration/selectedshippingservice"}Selected shipping services{/s}
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table pl-table">
                ...
                <tr class="pl-table-header-wrapper">
                    <th scope="col" class="pl-table-header-select">
                        {s name="configuration/select"}SELECT{/s}
                    </th>
                    <th scope="col" class="pl-table-header-title">
                        {s name="configuration/services"}SHIPPING SERVICES{/s}
                    </th>
                    <th scope="col" class="pl-table-header-carrier">
                        {s name="configuration/carrier"}CARRIER{/s}
                    </th>
                    <th scope="col" class="pl-table-header-transit">
                        {s name="configuration/transittime"}TRANSIT TIME{/s}
                    </th>
                    <th scope="col" class="pl-table-header-type">
                        {s name="configuration/type"}Type{/s}
                    </th>
                    <th scope="col" class="pl-table-header-origin">
                        {s name="configuration/origin"}ORIGIN{/s}
                    </th>
                    <th scope="col" class="pl-table-header-arrow">

                    </th>
                    <th scope="col" class="pl-table-header-destination">
                        {s name="configuration/destination"}DESTINATION{/s}
                    </th>
                    <th scope="col" class="pl-table-header-actions">
        ...
        <div id="pl-shipping-methods-result-template">
            <div class="pl-num-shipping-method-results-wrapper">
                {s name="configuration/showing"}Showing{/s} <span id="pl-number-showed-methods"></span>
                {s name="configuration/results"}results{/s}
            </div>
        </div>
        ...
        <div id="pl-packlink-percent-template">
            <div class="row">
                <div class=" pl-form-section-subtitle-wrapper">
                    {s name="configuration/pricingrulesubtitle"}Please set pricing rule{/s}
                </div>
            </div>
            <div class="row">
                <div class=" pl-form-section-input-wrapper pl-price-increase-wrapper">
                    <div class="pl-input-price-switch selected" data-pl-packlink-percent-btn="increase">
                        {s name="configuration/increase"}Increase{/s}
                    </div>
                    <div class="pl-input-price-switch" data-pl-packlink-percent-btn="decrease">
                        {s name="configuration/reduce"}Reduce{/s}
                    </div>
                    <div class="form-group pl-form-section-input pl-text-input">
                        <input type="text" class="form-control" id="pl-perecent-amount"/>
                        <span class="pl-text-input-label">{s name="configuration/by"}BY{/s} %</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="pl-fixed-prices-by-weight-template">
            <div class="row">
                <div class=" pl-form-section-subtitle-wrapper">
                    {s name="configuration/priceweightsubtitle"}Please add price for each weight criteria{/s}
                </div>
            </div>
            ...
            <div class="row">
                <div class=" pl-form-section-input-wrapper">
                    <div class="pl-fixed-price-add-criteria-button" id="pl-fixed-price-add">
                        + {s name="configuration/addprice"}Add price{/s}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class=" pl-form-section-input-wrapper pl-fixed-price-wrapper">
                        ...
                        <div class="form-group pl-form-section-input pl-text-input">
                            ...
                            <span class="pl-text-input-label">
						{s name="configuration/to"}TO{/s} (kg)</span>
                        </div>
                        <div class="form-group pl-form-section-input pl-text-input">
                            <input type="text" data-pl-fixed-price="amount"/>
                            <span class="pl-text-input-label">
						    {s name="configuration/price"}PRICE{/s} (€)</span>
                        </div>
        ...
        <div id="pl-fixed-prices-by-value-template">
            <div class="row">
                <div class=" pl-form-section-subtitle-wrapper">
                    {s name="configuration/pricepricesubtitle"}Please add price for each price criteria{/s}
                </div>
            </div>
                ...
                <div class="row">
                    <div class=" pl-form-section-input-wrapper pl-fixed-price-wrapper">
                        ...
                        <div class="form-group pl-form-section-input pl-text-input">
                            <input type="text" data-pl-fixed-price="to"/>
                            <span class="pl-text-input-label">
						{s name="configuration/to"}TO{/s} (€)</span>
                        </div>
                        <div class="form-group pl-form-section-input pl-text-input">
                            <input type="text" data-pl-fixed-price="amount"/>
                            <span class="pl-text-input-label">
        ...
        <div id="pl-order-state-mapping-template">
            <div class="pl-mapping-page-wrapper">
                <div class="row">
                    <div class=" pl-basic-settings-page-title-wrapper">
                        {s name="configuration/maporderstatusestitle"}Map order statuses{/s}
                    </div>
                </div>
                <div class="row">
                    <div class=" pl-basic-settings-page-description-wrapper">
                    {s name="configuration/maporderstatusesdesc"}Packlink offers you the possibility to update your Shopware order status with the shipping info. You can
                    edit anytime.{/s}
                    </div>
                </div>
                <div>
                    <div class="pl-mapping-page-select-section">
                        {s name="configuration/packlinkshippingstatus"}Packlink PRO Shipping Status{/s}
                    </div>
                    <div class="pl-mapping-page-wrapper-equals">
                    </div>
                    <div class="pl-mapping-page-select-section">
                        {s name="configuration/shopwareorderstatus"}Shopware Order Status{/s}
                    </div>
                </div>

                <div>
                    <div class="pl-mapping-page-select-section">
                        <input type="text" value="{s name="configuration/pending"}Pending{/s}" readonly>
                    </div>
                    <div class="pl-mapping-page-wrapper-equals">
                        =
                    </div>
                ...
                <div>
                    <div class="pl-mapping-page-select-section">
                        <input type="text" value="{s name="configuration/processing"}Processing{/s}" readonly>
                    </div>
                    <div class="pl-mapping-page-wrapper-equals">
                        =
                    </div>
                ...
                <div>
                    <div class="pl-mapping-page-select-section">
                        <input type="text" value="{s name="configuration/readyforshipping"}Ready for shipping{/s}"
                               readonly>
                    </div>
                    <div class="pl-mapping-page-wrapper-equals">
                        =
                ...
                <div>
                    <div class="pl-mapping-page-select-section">
                        <input type="text" value="{s name="configuration/intransit"}In transit{/s}" readonly>
                    </div>
                    <div class="pl-mapping-page-wrapper-equals">
                        =
                    </div>
                ...
                <div>
                    <div class="pl-mapping-page-select-section">
                        <input type="text" value="{s name="configuration/delivered"}Delivered{/s}" readonly>
                    </div>
                    <div class="pl-mapping-page-wrapper-equals">
                        =
                    </div>
                ...
                <div>
                    <button class="button button-primary btn-lg" id="pl-save-mappings-btn">
                        {s name="configuration/savechanges"}Save changes{/s}</button>
                </div>
            </div>
        </div>
            ...
            <div class="pl-footer-row">
                <div class="pl-system-info-panel hidden loading" id="pl-system-info-panel">
                    ...
                    <div class="pl-system-info-panel-content">
                        <div class="md-checkbox">
                            <label class="pl-form-section-input-checkbox-label">
                                ...
                                <b>{s name="configuration/debugmode"}Debug mode{/s}</b>
                            </label>
                        </div>
                    ...
                    <div class="pl-system-info-panel-loader">
                        <b>{s name="configuration/loading"}Loading...{/s}</b>
                    </div>
                ...
                <div class="pl-footer-wrapper">
                    <div class="pl-footer-system-info-wrapper">
                        v{$pluginVersion} <span class="pl-system-info-open-btn"
                                                                      id="pl-system-info-open-btn">({s name="configuration/systeminfo"}system info{/s})</span>
                    </div>
                    <div class="pl-footer-copyright-wrapper">
                        <a href="{$termsUrl}" target="_blank">
                            {s name="configuration/generalcondition"}General conditions{/s}
                        </a>
                        <p class="pl-managed-by">{s name="configuration/develpedandmanaged"}Developed and managed by Packlink{/s}</p>
                    </div>
                </div>
            </div>
        </div>
...
{block name="content/javascript"}
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Packlink.errorMsgs = {
                required: "{s name="error/required"}Field is required.{/s}",
                numeric: "{s name="error/number"}Value must be valid number.{/s}",
                invalid: "{s name="error/feildnotvalid"}Value must be valid number.{/s}",
            ...
            Packlink.successMsgs = {
                shippingMethodSaved: '{s name="success/servicesave"}Shipping service successfully saved.{/s}'
            };

            Packlink.labelMsgs = {
                empty: '{s name="label/empty"}Empty{/s}'
            };
