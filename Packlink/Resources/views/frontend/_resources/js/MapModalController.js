...
(function () {
  function MapModalControllerConstructor(configuration) {
    ...
    function display() {
      ...
      ajaxService.get(configuration.getUrl + '?methodId=' + configuration.methodId, getLocationsSuccessHandler)
    }
    ...
    function selectDropoff() {
      ...
      ajaxService.post(
          ...
          {carrierId: configuration.carrierId, dropOff: getSelectedDropoff()},
