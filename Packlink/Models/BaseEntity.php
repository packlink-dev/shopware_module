...
/**
 * Class BaseEntity
 * @package Packlink\Models
 *
 * Base entity is had to be created in order to enable PacklinkEntity and TestEntity to use different tables.
 * If for example TestEntity extends Packlink entity instead of a base entity due to double table annotation
 * (one in PacklinkEntity one in TestEntity) doctrine fails to properly transpile dql to sql therefore base class with
 * no table annotation has been created.
 */
abstract class BaseEntity extends ModelEntity
{
    /**
     * @var integer $id
     *
